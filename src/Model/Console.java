...
public class Console {
            ...
            switch (pilih){
                ...
                {    
                    ...
                    {   
                        ...
                        menuPetugas(app.getPetugasUsername(username));
                    }
                break;
                }
                case "4" :
    ...
    public void menuPetugas(Petugas petugas) {
        String pilih;
        ...
        switch (pilih){
            case "1" :
            {
                AnggotaPinjam(petugas); break;
            }    
            case "2" :
            {
                kembalikanBuku(petugas); break;
            }
    ...
    public void AnggotaPinjam(Petugas petugas){
...
//        }
        if(anggota == null){
            ...
            switch(answer)
            {
                case "1" : AnggotaPinjam(petugas); break;
                case "0" : menuPetugas(petugas); break;
            }
        }
        else {
            boolean done = false;
...
//                }
                if((jumlahPinjam + jumlahBuku) <= 6) {
                    app.inputPeminjaman(id, anggota, petugas);
                    ...
                    System.out.println("ERROR - Inputan Berupa Angka");
    ...
    public void kembalikanBuku(Petugas petugas){
        System.out.println("Masukan ID Anggota");
        String id; Anggota anggota = null;
        id = scanString.nextLine();
       // anggota = app.searchIdAnggota(id);
        if(anggota == null){
            ...
            switch(answer)
            {
                case "1" : kembalikanBuku(petugas); break;
                case "0" : menuPetugas(petugas); break;
            }
        }
        else {
