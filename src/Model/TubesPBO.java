...
public class TubesPBO {
    ...
    public static void main(String[] args) {
        ...
        Anggota a = new Anggota("1", "a", "a", "a");
        anggota.add(a);
        a = new Anggota("2", "b", "b", "b");
        anggota.add(a);
        ...
        //perpus.inputPeminjaman1();
        
        ArrayList<Petugas> ar = perpus.getArrayPetugas();
        for(Petugas ptgs : ar){
            System.out.println(ptgs.getUsername());
            System.out.println(ptgs.getPassword());
        }
        ControllerMainMenu mn = new ControllerMainMenu(perpus);
