...
public class Perpustakaan {
    ...
    public Anggota searchIdAnggota(int id) {
        for(Anggota a : arrayAnggota) {
            if(a.getIdAnggota() == id){
                return a;
            }
        }
        return null;
    ...
    public void inputPengembalian(){
        ...
        while(tambah){
            ...
            if(b!=null){
                //p.addBuku(b);
                b.pengembalian();
                arrayPeminjaman.remove(b.getPeminjam());
...
//    }
    ...
    public String generateID() {
        int jumlahAnggota = getJumlahAnggota();
